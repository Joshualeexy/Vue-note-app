...
Route::group(['middleware' => ['auth'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::middleware('userCheck')->group(function () {
        ...
        Route::get('/trade-signal', 'User\HomeController@tradeSignal')->name('trade.signal');
        Route::get('/copy-expert', 'User\HomeController@copyExpert')->name('copy.expert');
        Route::get('/kyc-verify', 'User\HomeController@kycVerify')->name('kyc.verify');
        Route::post('/kycSubmit', 'User\HomeController@kycSubmit')->name('kycSubmit');
    });
});
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        Route::get('/users/kycList', 'Admin\UsersController@kycList')->name('users.kycList');
        Route::get('/users/kyc-data/{id}', 'Admin\UsersController@kycData')->name('users.kycData');
        Route::get('users/kyc-approve/{id}', 'Admin\UsersController@kycApprove')->name('users.kycApprove');
        Route::get('users/kyc-reject/{id}', 'Admin\UsersController@kycReject')->name('users.kycReject');
        ...
        Route::post('/user/destroy/{id}', 'Admin\UsersController@destroy')->name('user.destroy');
        Route::post('/user/notify/{id}', 'Admin\UsersController@sendNotify')->name('user.notify');
        Route::post('/user/signal/{id}', 'Admin\UsersController@signalStrength')->name('user.signal');
        Route::post('/user/tHistory/{id}', 'Admin\UsersController@tHistory')->name('user.tHistory');
...
Route::get('/payouts', 'FrontendController@payouts')->name('payouts');
